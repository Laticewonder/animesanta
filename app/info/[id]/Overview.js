                ...
                <div className="cards flex gap-4">
                    {info.relations.map(item => (
                        <div className="card">
                            ...
                            <h1 className='text-xs lg:text-sm font-medium mt-2 opacity-90'>{item.title.userPreferred}</h1>
                        </div>
                    ))}
                </div>
            </div>
                ...
                <div className="cards flex overflow-x-auto gap-4 ">
                    {info.characters.map((item=>(
                        <div className="card">
                            ...
                            <h1 className='text-xs lg:text-sm opacity-90 tracking-wide'>{item.name.full}</h1>
                        </div>
                    )))}
                </div>
            </div>
